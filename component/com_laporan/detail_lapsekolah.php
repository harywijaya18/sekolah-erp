                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Detail Calon Siswa Berdasarkan Sekolah Asal </h1>
									...
									data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
												...
												<th data-field="asalsekolah" data-editable="false">Asal Sekolah</th>
										...
										<?php
											$no = 0;
											$query=mysqli_query($conn,"SELECT calon_siswa.*, m_sekolah.nama_sekolah
																		FROM calon_siswa
																		INNER JOIN m_sekolah
																		ON calon_siswa.kd_sekolah = m_sekolah.kd_sekolah
																		where calon_siswa.kd_sekolah = '$kd_sekolah'
