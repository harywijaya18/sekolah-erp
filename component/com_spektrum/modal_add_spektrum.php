                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header header-color-modal bg-color-1">
                                        <h4 class="modal-title">Form Tambah Spektrum Jurusan</h4>
                                    ...
                                    <div class="modal-body">            
                                            <div class="form-group">
												<input name="spektrum" id="spektrum" type="text" class="form-control" placeholder="Nama Spektrum Jurusan" required>
                                            </div>
											<div class="form-group">
												<input name="singkatan" id="singkatan" type="text" class="form-control" placeholder="Singkatan" required>
                                            </div>
