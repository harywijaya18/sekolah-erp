                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Mutasi Pendaftar Online ke Calon Siswa</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="?module=<?php echo $_GET['module'];?>&aksi=simpan" method="POST">
														<div class="row">
														...
														<div class="row">
																...
																<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																	<div class="input-mark-inner mg-b-22">
																		<input name="keterangan" id="keterangan" type="text" class="form-control" placeholder="Keterangan Pembayaran" autocomplete="off" value="DAFTAR ONLINE">
																		<span class="help-block"></span>
																	</div>
																</div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    ...
                                                                    <button id="btnAdd" type="submit" class="btn btn-primary waves-effect waves-light">MUTASI</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
