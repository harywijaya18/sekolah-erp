                                                    ...
                                                    <form action="?module=<?php echo $_GET['module'];?>&aksi=simpan" class="dropzone dropzone-custom needsclick add-professors" method="POST">
                                                        <div class="row">
																...
																<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																	<div class="input-mark-inner mg-b-22">
																		<input name="nisn" id="nisn" type="text" class="form-control" placeholder="Nomor Induk Siswa Nasional" required autocomplete="off">
														...
														<div class="row">
																...
																<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
																	<div class="input-mark-inner mg-b-22">
																		<input name="tanggal_lahir" id="tanggallahir" type="text" class="form-control" data-mask="99-99-9999" placeholder="dd-mm-yyyy" autocomplete="off" required>
														...
														<div class="row">
																...
																<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																	<div class="input-mark-inner mg-b-22">
																		<input name="telp" id="telp" type="text" class="form-control" placeholder="Nomor Telp / Hp" required autocomplete="off">
																		<span class="help-block"></span>
																	</div>
																</div>
                                                        </div>
														...
														<div class="row">
																...
																<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																		...
																		<select name="kd_diskon" id="kddiskon" data-placeholder="Pilih Promo Diskon..." class="chosen-select" tabindex="-1" required>
