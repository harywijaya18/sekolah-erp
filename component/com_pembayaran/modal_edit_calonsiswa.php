                                                ...
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="?module=<?php echo $_GET['module'];?>&aksi=edit" method="POST">
														<div class="row">
																...
																<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																	<div class="input-mark-inner mg-b-22">
																		<input name="nisn" id="nisn" type="text" value="<?php echo $data['nisn'];?>" class="form-control" placeholder="Nomor Induk Siswa Nasional" required autocomplete="off">
														...
														<div class="row">
																...
																<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																	<div class="input-mark-inner mg-b-22">
																		<input name="telp" id="telp" type="text" value="<?php echo $data['telp'];?>" class="form-control" placeholder="Nomor Telp / Hp" required autocomplete="off">
																		<span class="help-block"></span>
																	</div>
																</div>
                                                        </div>
