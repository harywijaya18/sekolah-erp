                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
									...
									<div class="add-product">
										...
										-->
										<a href="?module=<?php echo $_GET['module'];?>&aksi=add">Tambah Calon Siswa</a>
										<!--
									...
									data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
										...
										?>
                                            ...
                                            <tr>
                                                <!--<td></td>-->
												<td>
													<a href="?module=det_csiswa&aksi=&id=<?php echo $row['kd_siswa'];?>" class="btn btn-social-icon" data-toggle="modal" title="Klik untuk detail data Calon Siswa"><i class="fa fa-info-circle edu-informatio" aria-hidden="true"></i></a>
                                                ...
                                                <td><?php echo date("d-m-Y", strtotime($row['tanggal_buat']));?> </td>
